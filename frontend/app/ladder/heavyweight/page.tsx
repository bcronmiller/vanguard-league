...
export default function HeavyweightPage() {
  ...
  const loadLadder = async () => {
    try {
      ...
      const endpoint = isStatic
        ...
        : `${config.apiUrl}/api/ladder/weight-class/Heavyweight`;
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-mbjj-dark">
      ...
      {/* Page Title */}
      <div className="bg-gradient-to-r from-mbjj-red to-red-900 text-white py-8">
        <div className="container mx-auto px-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border-t-4 border-mbjj-red">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-mbjj-red text-white">
                <tr>
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {fighters.map((fighter, idx) => (
                  <tr key={fighter.player.id} className="hover:bg-red-50 dark:hover:bg-gray-700 transition">
          ...
          {fighters.length === 0 && (
            <div className="text-center py-12 text-gray-500">
              No heavyweight fighters with completed matches yet
            </div>
          )}
        </div>
