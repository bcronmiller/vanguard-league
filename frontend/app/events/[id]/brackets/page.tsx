...
const OFFLINE_MATCHES: Match[] = [
  ...
  { id: 1606, bracket_round_id: OFFLINE_BRACKET_ID, match_number: 6, a_player_id: 11, b_player_id: 21, result: 'a_win', method: 'Rear naked choke', match_status: 'completed', duration_seconds: null, depends_on_match_a: null, depends_on_match_b: null },
